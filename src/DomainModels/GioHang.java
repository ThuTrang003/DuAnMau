...
public class GioHang {
    ...
    public GioHang(String id, String idKH, String idNV, String ma, Date ngayTao, Date ngayThanhToan, String idtenNguoiNhan, String diaChi, String sdt, int tinhTrang) {
        this.id = id;
        this.idKH = idKH;
        this.idNV = idNV;
        this.ma = ma;
